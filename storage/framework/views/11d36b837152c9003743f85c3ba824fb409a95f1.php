                ...
                <table class="table table-condensed" style="<?php echo e((\Auth::user()->role == 'master')?'':'width:800px'); ?>">
                  ...
                  <?php $__currentLoopData = $schools; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $school): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tr>
                      ...
                      <?php if(\Auth::user()->role == 'master'): ?>
                        <td>
                          <a class="btn btn-danger btn-sm" href="<?php echo e(url('register/admin/'.$school->id.'/'.$school->code)); ?>"><small>+ Create Admin</small></a>
                        </td>
                        <td>
                          <a href="<?php echo e(url('school/admin-list/'.$school->id)); ?>"><small>View Admins</small></a>
                        </td>
                      <?php endif; ?>
                    </tr>
                    <?php if(\Auth::user()->school_id == $school->id): ?>
