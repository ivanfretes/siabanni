...
<ul class="nav flex-column">
  <li class="nav-item active">
    <a class="nav-link" href="<?php echo e(url('home')); ?>"><i class="material-icons">dashboard</i> <span class="nav-link-text">Dashboard</span></a>
  </li>
  ...
  <li class="nav-item">
    <a class="nav-link" href="<?php echo e(url('school/sections?course=1')); ?>"><i class="material-icons">class</i> <span class="nav-link-text">Classes
        &amp; Sections</span></a>
  </li>
  <?php endif; ?>
  ...
  <li class="nav-item dropdown">
    ...
    <ul class="dropdown-menu" style="width: 100%;">
      <!-- Dropdown menu links -->
      <li>
        <a class="dropdown-item" href="<?php echo e(url('exams/create')); ?>"><i class="material-icons">note_add</i> <span class="nav-link-text">Add
            Examination</span></a>
      </li>
      <li>
      ...
      <li>
        <a class="dropdown-item" href="<?php echo e(url('exams')); ?>"><i class="material-icons">settings</i> <span class="nav-link-text">Manage
            Examinations</span></a>
      </li>
    </ul>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="<?php echo e(url('grades/all-exams-grade')); ?>"><i class="material-icons">assignment</i> <span class="nav-link-text">Grades</span></a>
  </li>
  <li class="nav-item" style="border-bottom: 1px solid #dbd8d8;"></li>
  <li class="nav-item">
    <a class="nav-link" href="<?php echo e(url('academic/routine')); ?>"><i class="material-icons">calendar_today</i> <span class="nav-link-text">Class
        Routine</span></a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="<?php echo e(url('academic/syllabus')); ?>"><i class="material-icons">vertical_split</i> <span class="nav-link-text">Syllabus</span></a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="<?php echo e(url('academic/notice')); ?>"><i class="material-icons">announcement</i> <span class="nav-link-text">Notice</span></a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="<?php echo e(url('academic/event')); ?>"><i class="material-icons">event</i> <span class="nav-link-text">Event</span></a>
  </li>
  <li class="nav-item" style="border-bottom: 1px solid #dbd8d8;"></li>
  <li class="nav-item">
    <a class="nav-link" href="<?php echo e(url('create-school')); ?>"><i class="material-icons">settings</i> <span class="nav-link-text">Academic
        Settings</span></a>
  </li>
  <li class="nav-item dropdown">
    <a role="button" href="#" class="nav-link" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i
    ...
    <ul class="dropdown-menu" style="width: 100%;">
      ...
      <li>
        <a class="dropdown-item" href="<?php echo e(url('gpa/create-gpa')); ?>"><i class="material-icons">note_add</i> <span class="nav-link-text">Add
            New GPA</span></a>
      </li>
    </ul>
  </li>
  ...
  <li class="nav-item dropdown">
    ...
    <ul class="dropdown-menu" style="width: 100%;">
      <!-- Dropdown menu links -->
      <li>
        <a class="dropdown-item" href="<?php echo e(url('fees/all')); ?>"><i class="material-icons">developer_board</i> <span class="nav-link-text">Generate
            Form</span></a>
      </li>
      <li>
        <a class="dropdown-item" href="<?php echo e(url('fees/create')); ?>"><i class="material-icons">note_add</i> <span class="nav-link-text">Add
            Fee Field</span></a>
      </li>
    </ul>
  </li>
  ...
  <li class="nav-item dropdown">
    ...
    <ul class="dropdown-menu" style="width: 100%;">
      ...
      <li>
        <a class="dropdown-item" href="<?php echo e(url('accounts/income')); ?>"><i class="material-icons">note_add</i> <span class="nav-link-text">Add
            New Income</span></a>
      </li>
      <li>
  ...
  <li class="nav-item dropdown">
    ...
    <ul class="dropdown-menu" style="width: 100%;">
      <!-- Dropdown menu links -->
      <li>
        <a class="dropdown-item" href="<?php echo e(url('library/all-books')); ?>"><i class="material-icons">developer_board</i>
      ...
      <li>
        <a class="dropdown-item" href="<?php echo e(url('library/add-new-book')); ?>"><i class="material-icons">note_add</i> <span
